...
{
    public class SystemConfigDepartmentValidator : AbstractValidator<SystemConfigDepartment>
    {
        public SystemConfigDepartmentValidator()
        {
            RuleFor(x => x.Value).NotEmpty().WithMessage("Giá trị không để trống.");
